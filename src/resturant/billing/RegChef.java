 ...
 * @author hafiz
 */
public class RegChef extends javax.swing.JFrame {

    /**
     * Creates new form RegManager
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chief Register");

        jPanel1.setBackground(new java.awt.Color(204, 147, 103));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        query = "insert into resturant.dbo.chief VALUES ("+jTextField4.getText()+",'"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField5.getText()+"','"+jTextField3.getText()+"')";
        ...
        System.out.println(query);
            ...
            try{
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "New Chief Added");
